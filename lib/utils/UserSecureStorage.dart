...
class UserSecureStorage {
  ...
  static Future setStatusLogin(String status) async => await _STORAGE.write(key: _KEYSTATUSUSER, value: status);
  static Future<String> getStatus() async => await _STORAGE.read(key: _KEYSTATUSUSER);
